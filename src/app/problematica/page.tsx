          ...
          <div className="px-6 md:px-0">
            <div className="mx-auto max-w-2xl py-5 sm:py-10 md:py-20 lg:py-40">
              <div className="text-center">
                <h1 className="text-white text-3xl sm:text-4xl lg:text-5xl leading-relaxed font-extrabold">
                ...
                <p className="text-white mt-4 sm:mt-6 text-sm sm:text-lg leading-8 font-extrabold">
