          ...
          <main className="flex flex-col items-center justify-center p-6 h-screen w-screen">
            <div className="bg-black p-6 text-center">
              <div className="p-6 text-white">
                <h1 className="text-4xl sm:text-6x font-extrabold">Webgrafía</h1>
                <h1 className ="py-6 font-extrabold"> <a href="https://pea.ucr.ac.cr/wp-content/uploads/2020/08/Balanceo-por-Tanteo.pdf">Ley de la conservación de la Materia</a></h1>
