export default function Header() {
    return (
      ...
      <nav className="mx-auto flex flex-wrap max-w-7xl items-center justify-between p-4 " aria-label="Global">
  ...
  <div className="flex flex-row lg:flex-row lg:gap-x-12 w-full lg:w-auto justify-center items-center space-x-4">
    ...
    <a href="/ley" className="text-sm font-semibold leading-6 mb-2 lg:mb-0">Ley</a>
    <a href="/analisis" className="text-sm font-semibold leading-6 mb-2 lg:mb-0">Análisis</a>
    <a href="/problematica" className="text-sm font-semibold leading-6 mb-2 lg:mb-0">Problematica</a>
